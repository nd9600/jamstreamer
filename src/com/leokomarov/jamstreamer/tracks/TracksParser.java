 ...
 * @author LeoKomarov
 */
public class TracksParser extends ListActivity implements JSONParser.MyCallbackInterface  {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        String artistName = intent.getStringExtra(TracksSearch.INTENT_TAG); 
	...
	public void onRequestCompleted(JSONObject json) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(getApplicationContext(), TracksSingleItem.class);
